# COBI-Det Dataset
The official dataset links for the paper "A Real-World RGB Dataset and Lightweight Detection Transformer for Oracle Bone Inscriptions". The dataset will be made public shortly after the acceptance of the paper.
